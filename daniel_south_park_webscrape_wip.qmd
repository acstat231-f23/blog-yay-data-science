...
#table(unique(sp_scripts_full$Episode))
#need to make sure I have enough episodes...
```
...
```{r}
#bare code for counting IMPORTANT words spoken by a character
#do eric cartman first
